...
$opts = [
    "http" => [
        "method" => "GET",
       "header" => "Cookie: mac=00:1A:79:01:AD:B4\r\n".
"User-Agent: Mozilla/5.0 (QtEmbedded; U; Linux; C) AppleWebKit/533.3 (KHTML, like Gecko) MAG200 stbapp ver: 2 rev: 250 Safari/533.3\r\n" .
"X-User-Agent: Model: MAG250; Link: WiFi\r\n".
"Host: 149.56.31.235:88\r\n"
    ]
];
	
$context = stream_context_create($opts);
//$urltk="http://149.56.31.235:88:80/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
$urltk="http://149.56.31.235:88:80/stalker_portal/server/load.php?type=stb&action=handshake";
//$urltk="http://149.56.31.235:88:80/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
...
$jk="_";
$urlch="http://149.56.31.235:88/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%20http%3A%2F%2Flocalhost%2Fch%2F$cid";
//$urlch="http://149.56.31.235:88:80/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffmpeg%20http%3A%2F%2Flocalhost%2Fch%2F$cid";
...
//$urlch="http://149.56.31.235:88:80/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%20http%3A%2F%2Flocalhost%2Fch%2F$cid&JsHttpRequest=1-xml";
