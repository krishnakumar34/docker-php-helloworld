...
//$urlch="http://20.epiciptv.com:88/stalker_portal/server/load.php?type=vod&action=get_ordered_list&movie_id=$cid&JsHttpRequest=1-xml";
...
$data=$json2['js']['cmd'];
//echo $data;
//$m3url="https://sympathetic-rianon-personalkk-b701f149.koyeb.app/$data";
