...
$opts = [
    "http" => [
        "method" => "GET",
       "header" => "Cookie: mac=00:1A:79:6B:C3:1A\r\n".
...
$urltk="http://4kmini.live:80/portal.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
...
$s="_";
$t=time();
$urlpf="http://4kmini.live:80/portal.php?type=stb&action=get_profile&device_id=&device_id2=&auth_second_step=1&metrics=%7B%22mac%22%3A%2200%3A1a%3A79%3A6B%3AC3%3A1A%22%7D&hw_version_2=d6b3eba9bdc7fb3858d07cdcaa7a27ed8b10ecc6";
...
$jk="_";
$urlch="http://4kmini.live:80/portal.php?type=itv&action=create_link&forced_storage=undefined&download=0&cmd=ffmpeg%20http%3A%2F%2Flocalhost%2Fch%2F$cid$jk";
//$urlch="http://4kmini.live:80/portal.php?type=itv&action=get_ordered_list&genre=480";
