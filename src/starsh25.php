...
$opts = [
    ...
    "http" => [
       ...
       "header" => "Cookie: mac=00:1a:79:20:3a:8a\r\n".
...
$s="_";
$t=time();
$urlpf="http://starshare.live:8080/server/load.php?type=stb&action=get_profile&device_id=&device_id2=&auth_second_step=1&metrics=%7B%22mac%22%3A%2200%3A1A%3A79%3A20%3A3a%3A8a%22%7D&hw_version_2=d6b3eba9bdc7fb3858d07cdcaa7a27ed8b10ecc6&timestamp=$t";
