...
$mv="http://dhoom4u.me:80/stalker_portal/server/load.php?type=vod&action=get_ordered_list&category=37&movie_id=$cid&season_id=&episode_id=&p=0&sortby=added";
$context6 = stream_context_create($opts2);



$haystack6=file_get_contents($mv,false,$context6);
...
$json6 = json_decode($haystack6, true);
...
$data6=$json6['js']['data'];
$id=$data6[0]['id'];
$urlch="http://dhoom4u.me:80/stalker_portal/server/load.php?type=vod&action=create_link&cmd=%2Fmedia%2Ffile_$id.mpg";
