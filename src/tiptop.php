...
$portal = "portal.tiptop4k.tv/";
$mac = "00:1A:79:B6:D0:06";
$deviceid = "";
$deviceid2 = "";
$serial = "E7327B057414E";
$sig = "";

$n1 = "http://$portal/stalker_portal/server/load.php?type=stb&action=handshake&prehash=false&JsHttpRequest=1-xml";

$h1 = [
    "Cookie: mac=$mac; stb_lang=en; timezone=Asia%2FKolkata",
...
curl_close($c2_curl);
//echo var_dump($res2);
$n3="http://portal.tiptop4k.tv:80/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%20http://localhost/ch/$id&series=&forced_storage=0&disable_ad=0&download=0&force_ch_link_check=0&JsHttpRequest=1-xml";
