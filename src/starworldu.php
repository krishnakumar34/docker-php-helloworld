...
$opts = [
    "http" => [
        "method" => "GET",
       "header" => "Cookie: mac=00:1A:79:52:0B:C2\r\n".
...
//$urltk="http://star4u.world:80/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
$urltk="http://star4u.world:80/stalker_portal/server/load.php?type=stb&action=handshake";
//$urltk="http://star4u.world:80/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
...
$jk="_";
$urlch="http://star4u.world:80/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffmpeg%20http%3A%2F%2Flocalhost%2Fch%2F$cid";
...
//$urlch="http://star4u.world:80/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%20http%3A%2F%2Flocalhost%2Fch%2F$cid&JsHttpRequest=1-xml";
