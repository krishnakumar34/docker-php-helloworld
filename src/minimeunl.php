...
$opts = [
    "http" => [
        "method" => "GET",
       "header" => "Cookie: mac=00:1A:79:05:12:56\r\n".
"User-Agent: Mozilla/5.0 (QtEmbedded; U; Linux; C) AppleWebKit/533.3 (KHTML, like Gecko) MAG200 stbapp ver: 2 rev: 250 Safari/533.3\r\n" .
"X-User-Agent: Model: MAG250; Link: WiFi\r\n".
"Authorization:Bearer $token\r\n" .
"Host: minnm8544de.lstv.win:8080\r\n"
    ]
];
	
$context = stream_context_create($opts);
//$urltk="http://line.sohakiller.net/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
$urltk="http://minnm8544de.lstv.win:8080/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
...
$s="_";
$t=time();
$urlpf="http://minnm8544de.lstv.win:8080/server/load.php?type=stb&action=get_profile&device_id=&device_id2=&auth_second_step=1&metrics=%7B%22mac%22%3A%2200%3A1a%3A79%3A05%3A12%3A56%22%7D&hw_version_2=d6b3eba9bdc7fb3858d07cdcaa7a27ed8b10ecc6";
...
$jk="_";
$urlch="http://minnm8544de.lstv.win:8080/server/load.php?type=itv&action=create_link&forced_storage=undefined&download=0&cmd=ffmpeg%20http%3A%2F%2Flocalhost%2Fch%2F$cid$jk";
