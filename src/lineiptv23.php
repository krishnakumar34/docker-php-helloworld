...
"Cookie: mac=00:1A:79:47:4F:5A;stb_lang=en; timezone=GMT\r\n" .
...
$haystack = file_get_contents("http://line.crystalott.net:80/server/load.php?type=itv&action=get_ordered_list&genre=$cid&force_ch_link_check=&p=$p&JsHttpRequest=1-xml/",false,$context);
//echo $haystack;
