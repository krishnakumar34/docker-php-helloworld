...
$opts = [
    "http" => [
        "method" => "GET",
       "header" => "Cookie: mac=00:1a:79:AF:3A:E3\r\n".
"User-Agent: Mozilla/5.0 (QtEmbedded; U; Linux; C) AppleWebKit/533.3 (KHTML, like Gecko) MAG200 stbapp ver: 2 rev: 250 Safari/533.3\r\n" .
"X-User-Agent: Model: MAG250; Link: WiFi\r\n".
"Authorization:Bearer $token\r\n" .
"Host: 89.45.13.201:8080\r\n"
    ]
];
	
$context = stream_context_create($opts);
//$urltk="http://89.45.13.201:8080/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";

$urltk="http://89.45.13.201:8080/portal.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
...
$jk="_";
$urlch="http://89.45.13.201:8080/portal.php?type=itv&action=create_link&forced_storage=undefined&download=0&cmd=ffmpeg%20http%3A%2F%2Flocalhost%2Fch%2F$cid$jk";
//$urlch="http://89.45.13.201:8080/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%20http%3A%2F%2Flocalhost%2Fch%2F$cid&JsHttpRequest=1-xml";
