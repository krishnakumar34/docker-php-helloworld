...
$opts = [
    ...
    "http" => [
       ...
       "header" => "Cookie: mac=00:1A:79:49:ED:40\r\n".
...
$urltk="http://cdn.ipk.biz:80/stalker_portal/server/load.php?type=stb&action=handshake&token=&JsHttpRequest=1-xml";
...
$s="_";
$t=time();
$urlpf="http://cdn.ipk.biz:80/stalker_portal/server/load.php?type=stb&action=get_profile&device_id=AC8131B488BC36CB3B83FF0CF867F74DE73B1A128608AF54DC9F20E0FFE04F44&device_id2=AC8131B488BC36CB3B83FF0CF867F74DE73B1A128608AF54DC9F20E0FFE04F44&auth_second_step=1&metrics=%7B%22mac%22%3A%2200%3A1A%3A79%3A49%3AED%3A40%22%7D&hw_version_2=d6b3eba9bdc7fb3858d07cdcaa7a27ed8b10ecc6";
...
$urlch="http://cdn.ipk.biz:80/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%20http%3A%2F%2Flocalhost%2Fch%2F$cid";
//$urlch="http://cdn.ipk.biz:80/stalker_portal/server/load.php?type=itv&action=account_info";
//$urlch="http://cdn.ipk.biz:80/stalker_portal/server/load.php?type=vod&action=get_ordered_list&movie_id=$cid&JsHttpRequest=1-xml";
//echo $urlch;
